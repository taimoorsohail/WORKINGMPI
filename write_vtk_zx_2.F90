...
!      INCLUDE 'header_fft'
      ...
      parameter (ni=NX, nj=NZ+2,nk_st=820,nk=2000,NP=257)
...
!      EQUIVALENCE (U_data,CU_data)
      ...
      CHARACTER*37 file_name_1,file_time
...
!       PARAMETER (NX2P=NX2V/NP-1)    
	...
	DO k=nk_st,nk
	 ...
	 DO rank=0,NP-1
       ...
       file_name_1 = 'plane_data_ZX_2/'//base_name//file_num//PID//'.pln'
